document.addEventListener('DOMContentLoaded', function () {
  ...
  function getErrorMessage(type, fieldName, param) {
    const label = fieldName
      ? (document.querySelector('label[for="' + fieldName + '"]') || {}).textContent || fieldName
      : '';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '239d700d-1999-4d54-b876-296b6ef07dad',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '239d700d-1999-4d54-b876-296b6ef07dad';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '239d700d-1999-4d54-b876-296b6ef07dad';
